...
public class Maquina {
	...
	public int comprarRefri(int numRefri) {               //tenho credito?
		if (this.credito >= lista[numRefri].getPreco()){   // tem estoque?
			if (lista[numRefri].getQtde() > 0) {           
				...
				lista[numRefri].setQtde(qtdRefri);           // atualizo o estoque de refri
				return 0;
				}
			return -2;
		}
