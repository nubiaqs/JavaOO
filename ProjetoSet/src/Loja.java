...
public class Loja {
	public static void main(String[] args) {
		...
		// eu nao consigo fazer o percurso dessa lista com um "FOR" normal (com o índice
		// só consigo através do "FOR EACH" 
		// por que isso? Por que internamente eu uso o equivalente ao código anterior (com iterator)
		// for (Produto p: lista) {
